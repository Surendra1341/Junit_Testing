...
class TestTrial {
	...
	@Test
	void testAreaOfCircle_Message() {
		Shape shape = new Shape();
		assertNotEquals(576, shape.AreaOfSquare(24),"meassage to dev if test case failed");
	}
	
	@Test
	void testAreaOfCircle_Message_Supplier() {
		Shape shape = new Shape();
		assertNotEquals(500, shape.AreaOfSquare(24),()->"meassage to dev if test case failed");
	}
