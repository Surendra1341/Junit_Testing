...
class TestException {
	...
	void testSortingArray_Exception() {
		...
		*/
		int[] unsorted= {2,4,5};  //because passing proper data not generating exception then test should fail
		assertThrows(NullPointerException.class, ()->arrays.sortingArray(unsorted));
	}
